...
import { renderChatControls, renderChatSidebarAgentPicker, renderTab, renderThemeToggle } from "./app-render.helpers.ts";
          ...
          return html`
            <div class="nav-group ${isGroupCollapsed && !hasActiveTab ? "nav-group--collapsed" : ""}">
              ...
              <div class="nav-group__items">
                ...
                ${group.label === "chat" ? renderChatSidebarAgentPicker(state) : nothing}
              </div>
            </div>
          `;
        })}
